...
(function(n, l) {
    ...
    var Fb = /%20/g,
        ...
        Kb = /^\/\//,
        $a = /\?/,
        Lb = /<InvalidTag\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
...
WebFontConfig = {
    custom: {
        families: ["National"],
        urls: [TNZ.initialRequestConfig.staticDomain + "/visit/alacrity/fonts/national.base64.css"]
    },
    loading: function() {
        TNZ.Static.Fonts.ready = !1;
        $.event.trigger({
            type: "TNZ.Static.Fonts.loading"
        })
    },
    fontactive: function(n, l) {},
    active: function() {
        TNZ.Static.Fonts.ready = !0;
        $.event.trigger({
            type: "TNZ.Static.Fonts.load.success"
        })
    },
    inactive: function() {
        TNZ.Static.Fonts.ready = !0;
        $.event.trigger({
            type: "TNZ.Static.Fonts.load.fail"
        })
    }
};
(function() {
    var n = document.createElement("script");
    n.src = "cn" == TNZ.initialRequestConfig.market ? TNZ.initialRequestConfig.staticDomain + "/visit/alacrity/thirdparty/google/webfont.js" : ("https:" == document.location.protocol ? "https" : "http") + "://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js";
